...
<head>
    ...
    <title>Profile Page admin</title>
    <!-- Bootstrap CSS -->
...
<body>
    <form action="simpan_perubahan_admin.php" method="POST" enctype="multipart/form-data">
        <div class="container rounded bg-dark-light mt-5">
            <div class="row">
                <div class="col-md-4 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img
                            class="rounded-circle mt-5" src="config/uploads/<?php echo $foto; ?>" width="240" style="  border: 6px solid #ffffff;"><span
                    ...
                    <div class="p-3 py-5">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex flex-row align-items-center back">
                                <a href="beranda.php" style="color:#ffffff; text-decoration:none; ">Back to home</a>
                            </div>
